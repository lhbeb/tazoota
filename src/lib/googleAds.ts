...
const PURCHASE_CONVERSION_LABEL = 'HDqWCMSVmvocEKPnuOBE';
const ADD_TO_BASKET_CONVERSION_LABEL = 'TMG1CLyumvocEKPnuOBE';
const BEGIN_CHECKOUT_CONVERSION_LABEL = '';
export const PAGE_VIEW_CONVERSION_LABEL = '9fjXCOP9lPocEKPnuOBE';
