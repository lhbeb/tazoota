  ...
  return (
    <main className="min-h-screen bg-[#F5F7FB] py-12 sm:py-16">
      ...
      <div className="container mx-auto max-w-5xl px-4">
        <section className="mb-10 rounded-2xl bg-[#1e0e8b] px-6 py-8 text-[#F0F6FF] sm:px-8 sm:py-10 shadow-lg">
          <div className="mb-5 inline-flex items-center gap-2 rounded-full border border-[#F0F6FF]/10 bg-[#1e0e8b]/25 px-3.5 py-1.5 text-sm font-semibold text-[#f5970c]">
        ...
        <section className="mb-8 grid gap-4 md:grid-cols-3">
          <div className="rounded-xl border border-[#1e0e8b]/10 bg-white p-5 shadow-sm">
            <Clock className="mb-4 h-6 w-6 text-[#1e0e8b]" />
          ...
          <div className="rounded-xl border border-[#1e0e8b]/10 bg-white p-5 shadow-sm">
            <PackageCheck className="mb-4 h-6 w-6 text-[#1e0e8b]" />
          ...
          <div className="rounded-xl border border-[#1e0e8b]/10 bg-white p-5 shadow-sm">
            <ShieldCheck className="mb-4 h-6 w-6 text-[#1e0e8b]" />
        ...
        <section className="mb-8 rounded-2xl border border-[#1e0e8b]/10 bg-white p-6 shadow-sm sm:p-8">
          <div className="flex flex-col gap-3 border-b border-gray-100 pb-5 sm:flex-row sm:items-end sm:justify-between">
            ...
            <span className="inline-flex w-fit rounded-full bg-[#f5970c] px-3.5 py-1 text-sm font-semibold text-[#1e0e8b]">
              ...
              <ul className="mt-4 space-y-3 text-sm leading-6 text-gray-600">
                {section.items.map((item) => (
                  <li key={item} className="flex gap-3">
                    <span className="mt-2 h-1.5 w-1.5 flex-shrink-0 rounded-full bg-[#1e0e8b]" />
                    <span>{item}</span>
                  </li>
                ))}
              </ul>
        ...
        <section className="mt-8 rounded-2xl border border-[#1e0e8b]/10 bg-white p-6 shadow-sm sm:p-8">
          ...
          <Link
            href="/contact"
            className="mt-6 inline-flex items-center justify-center rounded-xl bg-[#1e0e8b] px-5 py-3 text-sm font-semibold text-[#F0F6FF] transition hover:bg-[#0a0f32]"
          >
            Contact Support
          </Link>
        </section>
