...
-- ============================================================
-- Store Settings Table (added 2026-09-20)
-- Stores per-store config (Shopify, etc.) in Supabase
-- so no env var changes are needed when switching stores.
-- ============================================================
...
-- Also create a standalone migration file
